...
namespace EazeCrawler.Extensions
{
    public static class ApplicationBuilderExtensions
    {
        ...
        private static IServiceProvider GetRequestServiceProvider(IApplicationBuilder builder)
        {
            ...
            if (accessor == null) throw new InvalidOperationException(typeof(IHttpContextAccessor).FullName);

            var context = accessor.HttpContext;
            if (context == null) throw new InvalidOperationException("No HttpContext.");
